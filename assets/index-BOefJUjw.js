...
void main() {
    ...
    `),this.bind("btn-again",n);const r=this.overlayContent.querySelector("#lb-section");if(s){r.innerHTML=`
        ...
        </div>`).join("")}</div>`:'<div class="lb-empty">No scores yet — be the first!</div>'}escape(e){return e.replace(/[<>&"]/g,t=>t==="<"?"&lt;":t===">"?"&gt;":t==="&"?"&amp;":"&quot;")}bind(e,t){const n=this.overlayContent.querySelector("#"+e);n&&n.addEventListener("click",t)}}class up{constructor(){W(this,"key","tfbr_leaderboard_v1");W(this,"max",10)}load(){try{const e=localStorage.getItem(this.key);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(n=>typeof n.score=="number"&&typeof n.name=="string").sort((n,s)=>s.score-n.score).slice(0,this.max):[]}catch{return[]}}add(e,t){const s={name:(e||"ANON").trim().slice(0,12).toUpperCase()||"ANON",score:t,date:new Date().toISOString().slice(0,10)},r=this.load();r.push(s),r.sort((l,c)=>c.score-l.score);const o=r.slice(0,this.max);try{localStorage.setItem(this.key,JSON.stringify(o))}catch{}let a=-1;for(let l=0;l<o.length;l++)if(o[l].name===s.name&&o[l].score===s.score&&o[l].date===s.date){a=l;break}return{list:o,rank:a}}qualifies(e){const t=this.load();return t.length<this.max||e>t[t.length-1].score}}class dp{constructor(e,t,n){W(this,"player");W(this,"onFlip");W(this,"lookLayer");W(this,"stick");W(this,"stickKnob");W(this,"flipBtn");W(this,"lookId",null);W(this,"lookLast",{x:0,y:0});W(this,"moveId",null);W(this,"moveOrigin",{x:0,y:0});W(this,"radius",55);W(this,"active",!1);this.player=t,this.onFlip=n,this.lookLayer=document.createElement("div"),this.lookLayer.id="m-look",this.stick=document.createElement("div"),this.stick.id="m-stick",this.stickKnob=document.createElement("div"),this.stickKnob.id="m-knob",this.stick.appendChild(this.stickKnob),this.flipBtn=document.createElement("div"),this.flipBtn.id="m-flip",this.flipBtn.textContent="FLIP",e.appendChild(this.lookLayer),e.appendChild(this.stick),e.appendChild(this.flipBtn),this.setActive(!1),this.bind()}setActive(e){this.active=e,this.lookLayer.style.display=e?"block":"none",this.stick.style.display=e?"block":"none",this.flipBtn.style.display=e?"flex":"none",e||(this.player.touchInput.x=0,this.player.touchInput.z=0,this.lookId=null,this.moveId=null)}bind(){this.lookLayer.addEventListener("touchstart",o=>{if(o.preventDefault(),this.lookId===null){const a=o.changedTouches[0];this.lookId=a.identifier,this.lookLast={x:a.clientX,y:a.clientY}}},{passive:!1}),this.lookLayer.addEventListener("touchmove",o=>{o.preventDefault();for(const a of Array.from(o.changedTouches))a.identifier===this.lookId&&(this.player.applyLook(a.clientX-this.lookLast.x,a.clientY-this.lookLast.y),this.lookLast={x:a.clientX,y:a.clientY})},{passive:!1});const e=o=>{for(const a of Array.from(o.changedTouches))a.identifier===this.lookId&&(this.lookId=null)};this.lookLayer.addEventListener("touchend",e),this.lookLayer.addEventListener("touchcancel",e);const t=o=>{o.preventDefault(),o.stopPropagation();const a=o.changedTouches[0];this.moveId=a.identifier;const l=this.stick.getBoundingClientRect();this.moveOrigin={x:l.left+l.width/2,y:l.top+l.height/2},this.updateStick(a.clientX,a.clientY)},n=o=>{o.preventDefault();for(const a of Array.from(o.changedTouches))a.identifier===this.moveId&&this.updateStick(a.clientX,a.clientY)},s=o=>{for(const a of Array.from(o.changedTouches))a.identifier===this.moveId&&(this.moveId=null,this.player.touchInput.x=0,this.player.touchInput.z=0,this.stickKnob.style.transform="translate(-50%, -50%)")};this.stick.addEventListener("touchstart",t,{passive:!1}),this.stick.addEventListener("touchmove",n,{passive:!1}),this.stick.addEventListener("touchend",s),this.stick.addEventListener("touchcancel",s);const r=o=>{o.preventDefault(),o.stopPropagation(),this.flipBtn.classList.add("pressed"),setTimeout(()=>this.flipBtn.classList.remove("pressed"),120),this.onFlip()};this.flipBtn.addEventListener("touchstart",r,{passive:!1}),this.flipBtn.addEventListener("click",r)}updateStick(e,t){let n=e-this.moveOrigin.x,s=t-this.moveOrigin.y;const r=Math.hypot(n,s);r>this.radius&&(n=n/r*this.radius,s=s/r*this.radius),this.stickKnob.style.transform=`translate(calc(-50% + ${n}px), calc(-50% + ${s}px))`,this.player.touchInput.x=n/this.radius,this.player.touchInput.z=-s/this.radius}}class fp{constructor(e){W(this,"renderer");W(this,"scene");W(this,"camera");W(this,"clock",new qf);W(this,"levelManager",new ep);W(this,"ai",new op);W(this,"scoring",new lp);W(this,"leaderboard",new up);W(this,"effects");W(this,"hud");W(this,"player");W(this,"mobile");W(this,"isTouch",typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints>0));W(this,"hemiLight");W(this,"dirLight");W(this,"ambLight");W(this,"world",null);W(this,"worldGroup",null);W(this,"turkeys",[]);W(this,"state","start");W(this,"levelIndex",0);W(this,"timeLeft",Ha);W(this,"currentTarget",null);W(this,"hazardCooldown",0);W(this,"loop",()=>{requestAnimationFrame(this.loop);const e=Math.min(.05,this.clock.getDelta()),t=this.clock.elapsedTime;this.state==="playing"&&this.world&&(this.timeLeft-=e,this.scoring.update(e),this.player.update(e,this.world.obstacles,this.world.halfW,this.world.halfD),this.ai.update(this.turkeys,this.player.position2D,this.world,Zn[this.levelIndex],e),this.updateEquipment(e),this.updateTarget(),this.hud.update({time:Math.max(0,this.timeLeft),score:this.scoring.levelScore,combo:this.scoring.combo,level:this.levelIndex,target:Zn[this.levelIndex].targetScore,active:this.activeCount(),missed:this.scoring.levelMissed}),this.timeLeft<=0&&(this.hud.showPrompt(!1),this.endLevel()));for(const n of this.turkeys)n.syncTransform(e,t);if(this.effects.update(e),this.state==="playing"||this.state==="paused"){const n=this.effects.shakeOffset();this.camera.position.add(n)}this.renderer.render(this.scene,this.camera)});this.scene=new Gf,this.scene.background=new ke(1709072),this.scene.fog=new ns(1709072,30,80),this.camera=new It(78,window.innerWidth/window.innerHeight,.1,300),this.renderer=new yo({antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.domElement.id="game-canvas",e.appendChild(this.renderer.domElement),this.setupLights(),this.effects=new cp(this.scene),this.hud=new hp(e),this.player=new rp(this.camera,this.renderer.domElement),this.player.touchMode=this.isTouch,this.hud.setMobile(this.isTouch),this.mobile=new dp(e,this.player,()=>{this.state==="playing"&&this.tryFlip()}),this.bindInput(),window.addEventListener("resize",()=>this.onResize()),this.hud.showStart(()=>this.startGame()),this.loop(),window.__game=this}setupLights(){this.hemiLight=new Hf(16773328,4205080,.9),this.scene.add(this.hemiLight),this.dirLight=new Wf(16770736,.7),this.dirLight.position.set(20,40,10),this.scene.add(this.dirLight),this.ambLight=new Xf(16777215,.25),this.scene.add(this.ambLight)}applyTheme(e){this.scene.background=new ke(e.bg),this.scene.fog=new ns(e.fogColor,e.fogNear,e.fogFar),this.hemiLight.color.setHex(e.hemiSky),this.hemiLight.groundColor.setHex(e.hemiGround),this.hemiLight.intensity=e.hemiInt,this.dirLight.color.setHex(e.dirColor),this.dirLight.intensity=e.dirInt,this.ambLight.intensity=e.ambInt}bindInput(){this.renderer.domElement.addEventListener("mousedown",e=>{e.button===0&&(this.isTouch||(this.state==="playing"&&this.player.enabled?this.tryFlip():(this.state==="playing"||this.state==="paused")&&this.player.requestLock()))}),document.addEventListener("keydown",e=>{e.repeat||e.code==="KeyE"&&this.state==="playing"&&this.player.enabled&&this.tryFlip()}),document.addEventListener("pointerlockchange",()=>{this.state==="playing"&&!this.player.enabled?this.state="paused":this.state==="paused"&&this.player.enabled&&(this.state="playing")})}startGame(){this.scoring.resetGame(),this.levelIndex=0,this.hud.hideOverlay(),this.enterLevelIntro()}enterLevelIntro(){this.state="intro";const e=Zn[this.levelIndex];this.buildLevel(e),this.hud.setCritterLabel(e.critterLabel),this.hud.setFlipVerb(e.flipVerb),this.hud.showLevelIntro(e,()=>{this.hud.hideOverlay(),this.beginPlay()})}beginPlay(){this.state="playing",this.timeLeft=Ha,this.scoring.startLevel(),this.hud.setHudVisible(!0),this.isTouch?this.mobile.setActive(!0):this.player.requestLock()}buildLevel(e){this.teardownLevel();const t=this.levelManager.build(e);this.world=t,this.worldGroup=t.group,this.scene.add(t.group),this.applyTheme(t.theme),this.turkeys=[];const n=t.spawnPoints.slice();this.shuffle(n);const s=e.normalCount+e.bronzeCount;let r=0;for(let o=0;o<s;o++){const a=o>=e.normalCount,l=n[o%n.length],c=l.x+(Math.random()-.5)*2,h=l.y+(Math.random()-.5)*2;o%4===0&&r++;const u=new ap(c,h,a,e.species,e.baseSpeed,e.fleeSpeed,r);this.turkeys.push(u),this.scene.add(u.group)}this.player.reset(t.playerStart),this.effects.clear()}teardownLevel(){for(const e of this.turkeys)this.scene.remove(e.group),e.dispose();this.turkeys=[],this.worldGroup&&(this.scene.remove(this.worldGroup),this.worldGroup=null),this.world=null}endLevel(){this.player.releaseLock(),this.mobile.setActive(!1);const e=Zn[this.levelIndex];if(this.scoring.levelScore>=e.targetScore){const n=this.scoring.applyLevelBonuses(!0);this.levelIndex>=Zn.length-1?this.showFinal(!0):(this.state="levelComplete",this.hud.setHudVisible(!1),this.hud.showLevelComplete(e,this.scoring.levelScore,n,this.scoring.totalScore,()=>{this.levelIndex++,this.hud.hideOverlay(),this.enterLevelIntro()}))}else this.state="levelFail",this.hud.setHudVisible(!1),this.hud.showLevelFail(e,this.scoring.levelScore,e.targetScore,()=>{this.scoring.totalScore-=this.scoring.levelScore,this.hud.hideOverlay(),this.enterLevelIntro()},()=>{this.hud.hideOverlay(),this.startGame()})}showFinal(e){this.state="final",this.player.releaseLock(),this.mobile.setActive(!1),this.teardownLevel(),this.hud.setHudVisible(!1),this.hud.showFinal({totalScore:this.scoring.totalScore,flipped:this.scoring.totalTurkeys,golden:this.scoring.totalBronze,missed:this.scoring.totalMissed,bestCombo:this.scoring.bestCombo,grade:this.scoring.grade(),won:e,levelsCleared:e?Zn.length:this.levelIndex},this.leaderboard,()=>{this.hud.hideOverlay(),this.startGame()})}tryFlip(){if(this.currentTarget&&this.currentTarget.active){const e=this.currentTarget;e.flip();const t=this.scoring.flip(e.isBronze);this.effects.spawnSpray(new P(e.pos.x,e.hoverY+.6,e.pos.y),e.isBronze),this.hud.popup((e.isBronze?"GOLDEN! ":"")+"+"+t+(this.scoring.combo>1?` (x${this.scoring.combo})`:""),e.isBronze?"bronze":"good"),this.currentTarget=null}else{const e=this.scoring.miss();this.hud.popup(e<0?e.toString():"MISS","bad")}}updateTarget(){if(!this.world)return;const e=this.player.position2D,t=this.player.forwardDir();let n=null,s=-1/0;for(const r of this.turkeys){if(!r.active)continue;const o=r.pos.x-e.x,a=r.pos.y-e.y,l=Math.hypot(o,a);if(l>Qf)continue;const c=o/(l||1)*t.x+a/(l||1)*t.y;if(c<-.35)continue;const h=c*2-l;h>s&&(s=h,n=r)}this.currentTarget=n,this.hud.showPrompt(!!n)}updateEquipment(e){if(!this.world)return;for(const n of this.world.equipment){n.t+=n.speed*e*n.dir;const s=n.a.distanceTo(n.b);n.t>s?(n.t=s,n.dir=-1):n.t<0&&(n.t=0,n.dir=1);const r=s>0?n.t/s:0,o=n.a.x+(n.b.x-n.a.x)*r,a=n.a.y+(n.b.y-n.a.y)*r;n.mesh.position.set(o,0,a),n.spec.x=o,n.spec.z=a}this.hazardCooldown>0&&(this.hazardCooldown-=e);const t=this.player.position2D;for(const n of this.world.equipment){const s=n.spec;if(Math.abs(t.x-s.x)<s.w/2+.5&&Math.abs(t.y-s.z)<s.d/2+.5&&this.hazardCooldown<=0){const r=this.scoring.hazard();this.hud.popup(r<0?r.toString()+" HAZARD":"HAZARD","bad"),this.effects.spawnSpray(new P(t.x,.6,t.y),!1),this.hazardCooldown=1.2}}}activeCount(){let e=0;for(const t of this.turkeys)t.active&&e++;return e}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}shuffle(e){for(let t=e.length-1;t>0;t--){const n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}}}const bo=document.getElementById("app");if(!bo)throw new Error("Missing #app root element");new fp(bo);
